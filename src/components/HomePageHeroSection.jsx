                ...
                <div className='mx-auto max-w-7xl py-32 sm:py-48 lg:py-56'>
                    <div className=' text-center'>
                        ...
                        >
                            ...
                            <span className='text-primary-200'>1s</span> into Dynamic User
                            Experiences
                        </motion.h1>
                        <motion.p
                            initial={{ opacity: 0, y: 50 }}
                        ...
                        <div class='grid grid-cols-4 gap-4 font-exo'>
                            ...
                            <div class='font-semibold '>
                                <div className='m-auto flex w-full'>
                                    <div className='relative m-auto flex w-full align-middle justify-center text-center'>
                                        <ReactCurvedText
                                            width='200'
                                            height='200'
                                            cx='100'
                                            ...
                                            startOffset='10'
                                            reversed={true}
                                            text='USER FRIENDLY - RESPONSIVE - ADVANCE - SEO - '
                                            ...
                                            svgProps={null}
                                        />
                                        <UserIcon className='h-16  rounded-full w-16 p-4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-primary-200 text-white' />
                                    </div>
                                </div>
                                <div className='text-center p-6 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-yellow-500 via-yellow-300 to-yellow-100c rounded-md text-white'>
                                    <div>
                            ...
                            <div class='col-span-2 bg-gray-200 rounded-md '>03</div>
                        </div>
                    </div>
                </div>
            </div>
